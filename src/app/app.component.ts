...
export class AppComponent {
  ...
  constructor(public router: Router,private authService:AuthServiceService, private userService: UserServiceService) /* private menuItemService:MenuItemService, */ {  
  }
